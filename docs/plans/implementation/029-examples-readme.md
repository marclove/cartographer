# Task 29: Examples README

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Create a README documenting the examples directory: what each example demonstrates, prerequisites, and how to run them.

**Architecture:** Single markdown file at `examples/README.md`. Covers both examples, links to relevant documentation, and lists the framework features each example exercises.
...
**Cost:** Approximately $0.05–0.15 per run (10 ticks, haiku for assessments, sonnet for incident reports/resolutions).

**Runtime:** ~2.5 minutes (10 ticks at 15-second intervals).
...
git commit -m "docs: add examples README with usage instructions and feature overview"
```
