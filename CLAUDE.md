...
- **Leaf nodes**: ActionNode, ConditionNode, AgentNode, ReceiveNode, NotifyNode — do actual work
...
- **Decorators**: Inverter, Repeat, Retry, Timeout, Guard, AlwaysSucceed, AlwaysFail, UntilSuccess — wrap a single child
